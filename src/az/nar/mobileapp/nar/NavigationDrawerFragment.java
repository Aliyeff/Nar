...
public class NavigationDrawerFragment extends Fragment implements OnGroupExpandListener{
	...
	private static final String MENU_JSON_STRING = "\"menu\" : [{\"id\" : 1,"
			...
			+ "\"name\" : \"Operations\","
			+ "\"children\" : [{\"id\" : 21,"
			+ "\"name\" : \"Cancel Supplementary Offering\"},"
			+ "{\"id\" : 22,"
			+ "\"name\" : \"Order Supplementary Offering\"},"
			+ "{\"id\" : 23,"
			+ "\"name\" : \"Send SMS\"},"
			+ "{\"id\" : 24,"
			+ "\"name\" : \"Modify Primary Offering\"},"
			+ "{\"id\" : 25,"
			+ "\"name\" : \"Favourite Numbers\"},"
			+ "{\"id\" : 26,"
			+ "\"name\" : \"Activate Scratch Card\"},"
			+ "{\"id\" : 27,"
			+ "\"name\" : \"Money Transfer\"},],},"
			+ "{\"id\" : 3,"
			+ "\"name\" : \"Payment\","
...
//						getString(R.string.title_section3), }));
	...
	public void setUp(int fragmentId, DrawerLayout drawerLayout) {
		...
		//R.drawable.ic_drawer, /* nav drawer image to replace 'Up' caret */ deprecated at v7
